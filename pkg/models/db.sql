...
3. 80% — на максимум повторений (1-2)
4. 100% — 1 повторение
5. 105% — 1 повторение
6. 50% — на максимум повторений (8-10)', 'https://youtu.be/a-_DN9RIG5M'),
('Разводка гантелей лёжа', '14/12/10 повторений с прогрессивным весом — 3-4 подхода', 'https://youtu.be/X3KWxSckQvY'),
('Жим штанги лёжа под углом', '10 повторений с прогрессивным весом — 3 подхода', 'https://youtube.com/watch?v=KNilOj1M4_8'),
('Сведение рук в тренажёре бабочка', 'Прогрессивный вес на 10 повторений — 3 подхода', 'https://youtube.com/watch?v=D-4nAWIeHjY'),
('Жим в хаммере под 45', '50-60% от максимума на 8 повторений — 2 подхода', 'https://youtube.com/watch?v=ssbduaVarkc'),
...
('Пик бицепса', '15/12/10 раз — 4-5 подходов (по самочувствию)', 'https://youtube.com/watch?v=ChooNzf9Ue8'),
...
2. 10 раз. Сложность — 5-6
3. 8 раз. Сложность — 9
4. 8 раз. Сложность — 9-10
5. 30 раз. Сложность — 8-9', 'https://youtube.com/watch?v=0fB3bIFfae0'),
('Обратные выпады с весом', '8-10 раз на 1 ногу — 3 подхода, вес увеличиваем', 'https://youtube.com/watch?v=adRiUqBBu54'),
('Подъемы на носки сидя', '20/16/12 повторений, увеличиваем вес — 3 подхода', 'https://youtube.com/watch?v=P0oTNSFIkk8'),
('Жим ногами в тренажёре', '10-12 повторений с увеличением веса — 3-4 подхода', 'https://youtube.com/watch?v=jyphzYKrptw'),
('Сгибания', '8-12 раз — 3 подхода. Сложность — 6-9', 'https://youtube.com/watch?v=P9IicmoG-dg'),
('Ягодичный мостик', '75 раз — 2 подхода', 'https://youtube.com/watch?v=bfV-DH89jiM'),
...
('Махи гантелями в наклоне', '10/8/6 повторений – 3 подхода. Вес прогрессируем', 'https://youtube.com/watch?v=qwJe16txBo4'),
('Боковые махи', '8-12 повторений — 3 подхода. Сложность — 5-8', 'https://youtube.com/watch?v=Uyn5oXuC144'),
('Жим гантелями вверх на скамье', '6-12 повторений — 4 подхода. Сложность — 6-8', 'https://youtube.com/watch?v=gIalcIMg9Vw');
