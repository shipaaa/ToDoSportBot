...
const (
	...
	msgHelpCommand    = "Посмотреть упражнения другого пола  — /start\n" +
		"Все упражнения в этом боте — /allexercises\n" +
		"Программы тренировок — /training\n" +
		"Пришли мне свои персональные упражнения и добавлю их для тебя — <a href=\"https://t.me/almost_shipa\">Мой телеграм</a>\n" +
